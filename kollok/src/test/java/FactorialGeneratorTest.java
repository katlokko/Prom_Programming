...
class FactorialGeneratorTest {
    ...
    void testGenerateFactorialsValidInput() {
        List<Long> result;
        result = FactorialGenerator.generateFactorials(5);
    ...
    void testGenerateFactorialsZeroInput() {
        ...
        assertEquals("Число должно быть натуральным.", exception.getMessage(), "Сообщение об ошибке должно быть правильным.");
    }
